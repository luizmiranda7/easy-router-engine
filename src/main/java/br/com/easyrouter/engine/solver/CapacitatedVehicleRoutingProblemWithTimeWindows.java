...
class Par<K, V> {
  ...
  public static <K, V> Par<K, V> of(K element0, V element1) {
...
public class CapacitatedVehicleRoutingProblemWithTimeWindows {
  ...
  // start/end.
  private List<Par<Integer, Integer>> locations = new ArrayList();
  ...
  private List<Par<Integer, Integer>> orderTimeWindows = new ArrayList();
  ...
  private void buildOrders(int numberOfOrders,
    ...
    for (int order = 0; order < numberOfOrders; ++order) {
      locations.add(Par.of(randomGenerator.nextInt(xMax + 1),
      ...
      orderTimeWindows.add(Par.of(timeWindowStart, timeWindowStart + timeWindowWidth));
  ...
  private void solve(final int numberOfOrders, final int numberOfVehicles) {
    ...
    NodeEvaluator2 manhattanCallback = new NodeEvaluator2(){
        ...
        public long run(int firstIndex, int secondIndex) {
          try {
            Par<Integer, Integer> firstLocation = locations.get(firstIndex);
            Par<Integer, Integer> secondLocation = locations.get(secondIndex);
